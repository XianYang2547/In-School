clc;
clear;
options=gaoptimset('PopulationSize',100,'CrossoverFraction',0.8,'Generations',300,'MigrationFraction',0.1);% 设置种群大小100，交叉概率0.8，迭代300次,变异概率0.1
%% ga函数的参数设置
fun = @Rosenbrock; % 设置适应度函数句柄，在定义的函数名前加个@即可
